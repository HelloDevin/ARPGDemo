...
namespace ZZZ
{
    public class VFX_PoolManager : SingletonMono<VFX_PoolManager>
    {
        [System.Serializable]
        ...
        [SerializeField] private List<effectData> effectDates = new();

        private readonly Dictionary<CharacterNameList, Dictionary<string, Queue<GameObject>>> effectPool = new();
